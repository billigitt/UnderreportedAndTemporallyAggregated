function [OG1LowerR, OG1UpperR, OG1MeanR] = OG1_RInference_Trick_OutputOnly(I, w, priorShapeScale, P, M, sampleFactor)
...
OG1LowerR = nan(1, Tweekly);
OG1UpperR = nan(1, Tweekly);
OG1MeanR = nan(1, Tweekly);
...
for t = 2:Tweekly
    ...
    OG1LowerR(t) = iosr.statistics.quantile(Rmat(t, :), 0.025, [], [], likelihood(t, :));
    OG1UpperR(t) = iosr.statistics.quantile(Rmat(t, :), 0.975, [], [], likelihood(t, :));
    OG1MeanR(t) = sum(Rmat(t, :, inference).*likelihood(t, :))/sum(likelihood(t, :));
