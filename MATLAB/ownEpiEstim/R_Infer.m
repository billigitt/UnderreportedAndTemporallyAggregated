function [Mean, Upper, Lower, Shape, Scale] = R_Infer(I_02t, W, Par, tau, i)
...
for k = 1:tau
    ...
    Scale = Scale + Total_Infectiousness(I_02t(1:end-tau+k), W(i+k, :));

end
Scale = Scale + (1/Par(2));
Scale = 1/Scale;
Mean = Shape*Scale;
Upper = gaminv(0.975, Shape, Scale);
Lower = gaminv(0.025, Shape, Scale);
