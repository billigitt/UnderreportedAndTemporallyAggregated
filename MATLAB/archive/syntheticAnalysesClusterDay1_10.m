...
load('../MATs/largeScaleStudyOriginalClusterMaxInc200Prior1And2FirstDay10.mat')
load('../MATs/largeScaleStudyNewClusterMaxInc200Prior1And2FirstDay10.mat')
...
totalItOG = largeScaleStudyOriginalMethodMaxInc200Prior12FirstDay10.totalIterations;
totalItNew = largeScaleStudyNewClusterMaxInc200Prior12FirstDay10.totalIterations;
runTimeOG = largeScaleStudyOriginalMethodMaxInc200Prior12FirstDay10.runTime;
runTimeNew = largeScaleStudyNewClusterMaxInc200Prior12FirstDay10.runTime;
totalItOG(idx1s) = [];
totalItNew(idx1s) = [];
runTimeOG(idx1s) = [];
runTimeNew(idx1s) = [];
...
xlabel('Percentage of ssqimulations accepted (%)')
ylabel('Percentage of inferences (%)')
ytix = get(gca, 'YTick');
set(gca, 'YTick',ytix, 'YTickLabel',ytix*100)

trueR = largeScaleStudyNewClusterMaxInc200Prior12FirstDay10.trueR;
trueR(idx1s) = [];

reportedWeeklyI = largeScaleStudyNewClusterMaxInc200Prior12FirstDay10.reportedWeeklyI;
reportedWeeklyI(idx1s) = [];

%estREE = 
estRNew = largeScaleStudyNewClusterMaxInc200Prior12FirstDay10.meanRt;
estROG = largeScaleStudyOriginalMethodMaxInc200Prior12FirstDay10.meanRt;
estROG(idx1s) = [];
estRNew(idx1s) = [];

%upperREE = 
upperRNew = largeScaleStudyNewClusterMaxInc200Prior12FirstDay10.upperRt;
upperROG = largeScaleStudyOriginalMethodMaxInc200Prior12FirstDay10.upperRt;
upperROG(idx1s) = [];
upperRNew(idx1s) = [];

%lowerREE = 
lowerRNew = largeScaleStudyNewClusterMaxInc200Prior12FirstDay10.lowerRt;
lowerROG = largeScaleStudyOriginalMethodMaxInc200Prior12FirstDay10.lowerRt;
lowerROG(idx1s) = [];
lowerRNew(idx1s) = [];
