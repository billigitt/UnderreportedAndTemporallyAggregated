...
load('../MATs/largeScaleStudyOriginalMethodSmallEpiPrior1And2FirstDay1.mat')
load('../MATs/largeScaleStudyNewSmallEpiPrior1And2FirstDay1.mat')
...
trueR = largeScaleStudyNewSmallEpiPrior1And2FirstDay1.trueR;
trueR(idx1s) = [];

reportedWeeklyI = largeScaleStudyNewSmallEpiPrior1And2FirstDay1.reportedWeeklyI;
reportedWeeklyI(idx1s) = [];

%estREE = 
estRNew = largeScaleStudyNewSmallEpiPrior1And2FirstDay1.meanRt;
estROG = largeScaleStudyOriginalMethodSmallEpiPrior1And2FirstDay1.meanRt;
estROG(idx1s) = [];
estRNew(idx1s) = [];

%upperREE = 
upperRNew = largeScaleStudyNewSmallEpiPrior1And2FirstDay1.upperRt;
upperROG = largeScaleStudyOriginalMethodSmallEpiPrior1And2FirstDay1.upperRt;
upperROG(idx1s) = [];
upperRNew(idx1s) = [];
%lowerREE = 
lowerRNew = largeScaleStudyNewSmallEpiPrior1And2FirstDay1.lowerRt;
lowerROG = largeScaleStudyOriginalMethodSmallEpiPrior1And2FirstDay1.lowerRt;
lowerROG(idx1s) = [];
lowerRNew(idx1s) = [];
