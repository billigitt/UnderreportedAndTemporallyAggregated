...
load('../MATs/largeScaleStudyOriginalBigEpiLowRhosPrior1And2FirstDay100.mat')
load('../MATs/largeScaleStudyNewBigEpiLowRhosPrior1And2FirstDay100.mat')
...
idx1s = 1:11:(11*9*499+11*8+1);
idxAll = 1:(11*9*500);
idxNot1s = idxAll;
idxNot1s(idx1s) = [];

totalItOG = largeScaleStudyOriginalBigEpiLowRhosPrior1And2FirstDay100.totalIterations;
totalItNew = largeScaleStudyNewBigEpiLowRhosPrior1And2FirstDay100.totalIterations;
runTimeOG = largeScaleStudyOriginalBigEpiLowRhosPrior1And2FirstDay100.runTime;
runTimeNew = largeScaleStudyNewBigEpiLowRhosPrior1And2FirstDay100.runTime;
reportedWeeklyI = largeScaleStudyNewBigEpiLowRhosPrior1And2FirstDay100.reportedWeeklyI;
totalItOG(idx1s) = [];
totalItNew(idx1s) = [];
runTimeOG(idx1s) = [];
runTimeNew(idx1s) = [];
...
trueR = largeScaleStudyNewBigEpiLowRhosPrior1And2FirstDay100.trueR;
trueR(idx1s) = [];
...
%estREE = 
estRNew = largeScaleStudyNewBigEpiLowRhosPrior1And2FirstDay100.meanRt;
estROG = largeScaleStudyOriginalBigEpiLowRhosPrior1And2FirstDay100.meanRt;
estROG(idx1s) = [];
estRNew(idx1s) = [];

%upperREE = 
upperRNew = largeScaleStudyNewBigEpiLowRhosPrior1And2FirstDay100.upperRt;
upperROG = largeScaleStudyOriginalBigEpiLowRhosPrior1And2FirstDay100.upperRt;
upperROG(idx1s) = [];
upperRNew(idx1s) = [];

%lowerREE = 
lowerRNew = largeScaleStudyNewBigEpiLowRhosPrior1And2FirstDay100.lowerRt;
lowerROG = largeScaleStudyOriginalBigEpiLowRhosPrior1And2FirstDay100.lowerRt;
lowerROG(idx1s) = [];
lowerRNew(idx1s) = [];
...
rho = repmat(repelem((0.01:0.01:0.09)', 10), 500, 1);
...
idxCorrectNewIncorrectOGRaw = false*ones(49500, 1);
