...
weekly_vec = [weekly_vec; 1] #add one more week to make it 103 weeks with one extra case

        x = inferUnderRepAndTempAggR(weekly_vec, wAssumed, priorRShapeAndScale, 0.4, defaultM, defaultP, maxIter, maxIterEntire)
