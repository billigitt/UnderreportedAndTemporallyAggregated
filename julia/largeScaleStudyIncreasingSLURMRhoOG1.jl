...
criCheck = true
    ...
    x = inferTempAggOnlyR(incidenceAndTrueR.reportedWeeklyI, wAssumed, priorRShapeAndScale, defaultM, defaultP, maxIter, maxEntireIter)
...
CSV.write("../CSVs/largeScaleStudyClusterNoLimitIncreasingRhoOG1_$idx.csv", dfNew)
