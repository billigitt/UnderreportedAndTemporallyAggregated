...
time = 1:T
nEpidemics = Int(1100)
temporalRho = 1 ./ (1 .+ exp.(-(time .- 5.5)*log(9)/3.5)) # comes from https://www.cdc.gov/mmwr/preview/mmwrhtml/su6303a1.htm?s_cid-su6303a1_w#Appendix-tab4 Table 4, see correction factor
...
CSV.write("CSVs/largeScaleStudyIncidencesAndTrueRsNoLimitPrior1And3FirstDay1IncreasingRho.csv", df)
