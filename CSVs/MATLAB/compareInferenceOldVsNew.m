...
cri95WidthThreshold = (icdf('Gamma', 0.975, 1, 5) - icdf('Gamma', 0.025, 1, 5))*0.5;
...
xticks([realWorldNovelInferenceEbolaSingleNaiveRho04.date(1), realWorldNovelInferenceEbolaSingleNaiveRho04.date(34), realWorldNovelInferenceEbolaSingleNaiveRho04.date(68), realWorldNovelInferenceEbolaSingleNaiveRho04.date(end)])
xticklabels(datestr([realWorldNovelInferenceEbolaSingleNaiveRho04.date(1), realWorldNovelInferenceEbolaSingleNaiveRho04.date(34), realWorldNovelInferenceEbolaSingleNaiveRho04.date(68), realWorldNovelInferenceEbolaSingleNaiveRho04.date(end)], 'mm/yy'))
